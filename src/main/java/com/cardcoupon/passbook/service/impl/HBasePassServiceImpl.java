...
import com.cardcoupon.passbook.service.IHBasePassService;
...
public class HBasePassServiceImpl implements IHBasePassService {
    ...
    public boolean dropPassTemplateToHBase(PassTemplate passTemplate) {
        ...
        try{
            ...
            log.error("drop PassTemplate To HBase Error : {}", e.getMessage());
            return false;
        }
        ...
        put.addColumn(
                ...
                Bytes.toBytes(
                        DateFormatUtils.ISO_DATE_FORMAT.format(passTemplate.getStart())
                )
        );
        put.addColumn(
                Bytes.toBytes(Constants.PassTemplateTable.FAMILY_C),
                ...
                Bytes.toBytes(
                        DateFormatUtils.ISO_DATE_FORMAT.format(passTemplate.getEnd())
                )
        );
